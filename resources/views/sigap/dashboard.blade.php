@php
    $appConfig = [
        'systemName' => 'SIGAP Rudenim Surabaya',
    ...
    <div class="page-body">
        ...
        <section class="double-grid">
            ...
            <div class="panel">
                ...
                <div class="subtle-box">
                    ...
                    <ul>
                        <li>View ini bisa dipasang sebagai `resources/views/sigap/dashboard.blade.php`.</li>
        ...
        <section class="panel section-anchor" id="pengaturan">
            ...
            <div class="triple-grid settings-grid">
                <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(8,145,178,.10);color:var(--tosca)"><svg class="section-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="{{ $iconMap['dashboard'] }}"/></svg></div><div><strong>Master Data</strong><p>Pengelolaan referensi kebangsaan, kategori dokumen, lokasi, dan status operasional.</p></div></article>
                <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(13,148,136,.12);color:var(--green)"><svg class="section-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="{{ $iconMap['users'] }}"/></svg></div><div><strong>Hak Akses &amp; Akun</strong><p>Admin, petugas pendataan, dan supervisor dikelola di area ini beserta pembatasan peran.</p></div></article>
                <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(212,160,23,.12);color:var(--gold)"><svg class="section-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="{{ $iconMap['sync'] }}"/></svg></div><div><strong>Backup &amp; Restore</strong><p>Jadwal cadangan lokal, restore data, dan catatan pemulihan untuk lingkungan MVP intranet.</p></div></article>
                <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(24,79,130,.12);color:var(--tosca-deep)"><svg class="section-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="{{ $iconMap['shield'] }}"/></svg></div><div><strong>Keamanan</strong><p>Pengaturan sesi, catatan login, kontrol perubahan sensitif, dan persetujuan supervisor.</p></div></article>
                <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(13,148,136,.10);color:var(--green)"><svg class="section-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="{{ $iconMap['alert'] }}"/></svg></div><div><strong>Notifikasi</strong><p>Peringatan dokumen belum lengkap, perubahan kritis, dan jadwal rekap pelaporan.</p></div></article>
