    ...
    <section class="panel section-anchor" id="pengaturan">
        <div class="setting-head">
            <div class="setting-copy">
                ...
                <p>Hak akses dan akun tetap berada di dalam pengaturan, sesuai spesifikasi SIGAP dan tanpa menu Pengguna di navigasi utama.</p>
            </div>
            <span class="badge">Konfigurasi Laravel-ready</span>
        </div>

        <div class="triple-grid settings-grid">
            <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(8,145,178,.10);color:var(--tosca)"><x-icon name="dashboard" class="section-icon" /></div><div><strong>Master Data</strong><p>Pengelolaan referensi kebangsaan, kategori dokumen, lokasi, dan status operasional.</p></div></article>
            <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(13,148,136,.12);color:var(--green)"><x-icon name="users" class="section-icon" /></div><div><strong>Hak Akses &amp; Akun</strong><p>Peran aktif saat ini: {{ $currentRole['label'] }} melalui sumber {{ strtoupper($currentRole['source']) }}.</p></div></article>
            <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(212,160,23,.12);color:var(--gold)"><x-icon name="sync" class="section-icon" /></div><div><strong>Backup &amp; Restore</strong><p>Jadwal cadangan lokal, restore data, dan catatan pemulihan untuk lingkungan MVP intranet.</p></div></article>
            <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(24,79,130,.12);color:var(--tosca-deep)"><x-icon name="shield" class="section-icon" /></div><div><strong>Keamanan</strong><p>Pengaturan sesi, catatan login, kontrol perubahan sensitif, dan persetujuan supervisor.</p></div></article>
            <article class="setting-card"><div class="section-icon-wrap" style="width:48px;height:48px;background:rgba(13,148,136,.10);color:var(--green)"><x-icon name="alert" class="section-icon" /></div><div><strong>Notifikasi</strong><p>Peringatan dokumen belum lengkap, perubahan kritis, dan jadwal rekap pelaporan.</p></div></article>
