    ...
    <section class="panel section-anchor" id="data-pengungsi">
        <div class="section-head">
            ...
            <div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;">
                <span class="badge">{{ $refugees->total() }} total data</span>
        ...
        <form class="filters" method="GET" action="{{ route('refugees.index') }}">
            ...
            <button class="btn btn-primary" type="submit">
                <x-icon name="search" class="chip-icon" /> Terapkan Filter
            </button>
            <a class="btn btn-ghost" href="{{ route('refugees.index') }}" style="display:inline-flex;justify-content:center;align-items:center;">Reset</a>
        </form>
