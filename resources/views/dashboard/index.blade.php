    ...
    <section class="hero-panel section-anchor" id="dashboard">
        <div class="hero-copy">
            <span class="eyebrow">
                ...
                Sistem Informasi & Gerakan Administratif Pengungsi
            </span>
            <h3>Selamat datang, {{ $currentUser['name'] }}.</h3>
            <p>
                Pantau pendataan pengungsi luar negeri di wilayah kerja Rudenim Surabaya secara terpadu. SIGAP merangkum
                statistik harian, prioritas verifikasi, dan integrasi Firebase Realtime Database dalam satu tampilan ringkas.
            </p>
            <div class="hero-meta">
        ...
        <div class="hero-side">
            <div class="highlight-card">
                ...
                <p>Fokus pada data dengan dokumen identitas belum lengkap, perubahan lokasi aktif, dan histori unggah terbaru.</p>
            </div>
            <div class="highlight-card">
                <div class="highlight-head">
                    <strong>Sinkronisasi Firebase</strong>
                    <span class="mini-badge success">Aktif</span>
                </div>
                <p>Firebase Realtime Database tersinkronisasi otomatis tiap kali ada CRUD. Audit trail tercatat di node <code style="color:#fef3c7">/audit_trails</code>.</p>
            </div>
        </div>
    </section>
        ...
        <div class="panel">
            <div class="section-head">
                ...
                <div style="display:flex;gap:10px;flex-wrap:wrap;">
                    <a class="btn btn-ghost btn-sm" href="{{ route('refugees.index') }}">
                        <x-icon name="users" class="chip-icon" /> Buka daftar
                    </a>
                    @if ($canManageRefugees)
                        <a class="btn btn-primary btn-sm" href="{{ route('refugees.create') }}">
                            <x-icon name="check" class="chip-icon" /> Tambah data
                        </a>
                    @endif
                </div>
            </div>
