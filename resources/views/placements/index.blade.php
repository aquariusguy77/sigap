    ...
    <section class="panel section-anchor" id="penempatan">
        ...
        <form class="filters" method="GET" action="{{ route('placements.index') }}">
            ...
            <button class="btn btn-primary" type="submit">
                <x-icon name="search" class="chip-icon" /> Terapkan
            </button>
            <a class="btn btn-ghost" href="{{ route('placements.index') }}" style="display:inline-flex;justify-content:center;align-items:center;">Reset</a>
        </form>
