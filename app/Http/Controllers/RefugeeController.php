...
class RefugeeController extends Controller
{
    ...
    public function show(Refugee $refugee): View
    {
        return view('refugees.show', array_merge($this->baseViewData(), [
            ...
            'refugee' => $refugee,
            'placement' => $this->sigapDataService->samplePlacementByRefugeeId((int) $refugee->id),
            'document' => $this->sigapDataService->sampleDocumentByRefugeeId((int) $refugee->id),
            'history' => collect($this->sigapDataService->history())->where('refugee_id', (int) $refugee->id)->values(),
        ]));
    }
